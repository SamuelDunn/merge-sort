/*
 This client program will test the myMergeSort() function with a variety
 different input arrays and will compare the time-cost of using the merge-sort
...
int main() {
   ...
   cout <<  "Time-cost using myMergeSort() with 10000 element array:"
   << endl << endl;
   cout << fixed << setprecision(4);

   startClock = clock();
   myMergeSort(orderedArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   ...
   startClock = clock();
   myMergeSort(randomArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
   ...
   startClock = clock();
   myMergeSort(reverseOrderedArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
   ...
   startClock = clock();
   myMergeSort(uniformArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
   ...
   startClock = clock();
   myMergeSort(nearlyOrderedArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
   ...
   startClock = clock();
   myMergeSort(orderedWithDuplicateElements, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
